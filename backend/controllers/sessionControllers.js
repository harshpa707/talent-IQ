import { chatClient, streamClient } from "../src/lib/stream.js";
...
export async function joinSessions(req, res) {
  try {
    ...
    console.log("Error in joinSessions controller:", error.message);
    res.status(500).json({
      message: "Internal Server Error",
    });
  }
...
export async function endSessions(req, res) {
  try {
    ...
    console.log("Error in endSessions controller:", error.message);
    res.status(500).json({
      message: "Internal Server Error",
    });
  }
